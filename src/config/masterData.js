...
export const carouselSteps = [
  {
    title: locale.vannila_detail.carousel_steps.notice,
    image: carouselFsStep,
    iconStep: carouselFsIcon
  },
  {
    title: locale.vannila_detail.carousel_steps.approve,
    image: carouselScStep,
    iconStep: carouselScIcon
  },
  {
    title: locale.vannila_detail.carousel_steps.vacation,
    image: carouselTdStep,
    iconStep: carouselTdIcon
  }
]
...
export const employeeData = [
  {
    ...
    icon: [
      { title: locale.vannila_detail.employee.employee_profile.remainder, icon: clockIcon },
...
export const tabs = [
  {
    title: locale.vannila_detail.tabs.manage,
    image: tabFsStep,
    iconA: tabActiveFsIcon,
    icon: tabFsIcon
  },
  {
    title: locale.vannila_detail.tabs.edit,
    image: tabScStep,
    iconA: tabActiveScIcon,
    icon: tabScIcon
  },
  {
    title: locale.vannila_detail.tabs.move,
    image: tabTdStep,
